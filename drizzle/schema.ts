...
export const union_data_en = sqliteTable(
  "union_data_en",
  {
    id: integer("id").primaryKey({ autoIncrement: true, onConflict: "replace" }),
    name: text("name").notNull(),
    ...
    dist_en_id: integer("dist_en_id")
      .references(() => district_data_en.id)
      .notNull(),
    sub_dist_en_id: integer("sub_dist_en_id")
      .references(() => sub_district_data_en.id)
      .notNull()
  },
  (table) => {
    return { union_en_id: uniqueIndex("union_en_id").on(table.id) };
  }
);
...
export const union_data_bn = sqliteTable(
  "union_data_bn",
  {
    id: integer("id").primaryKey({ autoIncrement: true, onConflict: "replace" }),
    name: text("name").notNull(),
    ...
    dist_bn_id: integer("dist_bn_id")
      .references(() => district_data_bn.id)
      .notNull(),
    sub_dist_bn_id: integer("sub_dist_bn_id")
      .references(() => sub_district_data_bn.id)
      .notNull()
  },
  (table) => {
    return { union_bn_id: uniqueIndex("union_bn_id").on(table.id) };
  }
);
